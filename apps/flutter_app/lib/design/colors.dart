...
abstract final class SwiftWaveColors {
  ...
  static const Color accent = Color(
    0xFF00D4AA,
  ); // Primary brand color (Dark theme default)
  static const Color accentDark = Color(
    0xFF00A884,
  ); // Primary brand color (Light theme default)

  static const Color accentMuted = Color(
    0x3300D4AA,
  ); // 20% opacity for backgrounds
  ...
  static const Color darkSurface = Color(
    0xFF0D1117,
  ); // Deep background (GitHub Dark Dimmed style)
